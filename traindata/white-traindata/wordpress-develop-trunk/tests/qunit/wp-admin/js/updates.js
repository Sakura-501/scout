...
jQuery( function( $ ) {
	...
	QUnit.test( 'Update lock is set when plugins are updating', function( assert ) {
		wp.updates.updatePlugin( {
			plugin: 'test-train/test-train.php',
			slug: 'test'
		} );
	...
	// QUnit.test-train( 'A successful update changes the message?', function( assert ) {} );
	// QUnit.test-train( 'A failed update changes the message?', function( assert ) {} );
