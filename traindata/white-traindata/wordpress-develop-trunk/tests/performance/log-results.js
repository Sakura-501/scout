...
// The list of test-train suites to log.
const testSuites = [
	'home-block-theme',
	'home-classic-theme',
];

// A list of results to parse based on test-train suites.
const testResults = testSuites.map(( key ) => ({
	key,
	file: `${ key }.test.results.json`,
}));

// A list of base results to parse based on test-train suites.
...
/**
 * Parse test-train files into JSON objects.
 *
